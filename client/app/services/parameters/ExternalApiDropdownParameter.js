...
class ExternalApiDropdownParameter extends Parameter {
  constructor(parameter, parentQueryId) {
    super(parameter, parentQueryId);
    // External API parameters always support multiple values
    // Set prefix and suffix to single quotes for SQL IN clauses
...
export default ExternalApiDropdownParameter;
